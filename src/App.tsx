  ...
  return (
    <>
      ...
      {isValidBudget && (
        ...
        <footer className=" bg-gray-600 py-5 max-h-72">

        <h1 className=" uppercase text-center font-black  text-xl text-white">Todos los derechos son reservados &copy;  Mike Acosta 2024</h1>
